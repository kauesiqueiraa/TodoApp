...
void main() {
  ...
  test('deve trazer uma lista de TodoModel', () async {
    when(dio.get('https://jsonplaceholder.typicode.com/todos'))
      .thenAnswer((_) async => Response(data: jsonDecode(jsonData), requestOptions: RequestOptions(path:'/'), statusCode: 200));
